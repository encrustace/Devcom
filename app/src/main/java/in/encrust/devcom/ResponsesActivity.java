...
import in.encrust.devcom.AdapterClasses.ResponsesAdapter;
    ...
    public void loadResponses() {
        ...
        userDatabaseReference.addValueEventListener(new ValueEventListener() {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if (post.getReceiveruid().equals(userId)) {
                            ...
                            noData.setText("No Responses");
                        }
                    }

                    ResponsesAdapter responsesAdapter = new ResponsesAdapter(ResponsesActivity.this, postList);

                    recyclerView.setLayoutManager(new LinearLayoutManager(ResponsesActivity.this));
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ResponsesActivity.this, databaseError.toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
